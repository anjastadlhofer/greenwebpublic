 <hr class="m-0">
    <section class="resume-section p-3 p-lg-5 d-flex justify-content-center" id="dummy">
      <div class="w-100">
        <h2 class="mb-5">Ein Webseitenaufruf, so viele Server ...</h2>
        <div class="resume-item d-flex flex-column flex-md-row justify-content-between mb-5">
          <div class="resume-content">
            
            <h3 class="mb-0">xxx</h3>
            <div class="subheading mb-3">xxxxxxxxxxxx</div>
            <p>
                <div id="lb" >
                  <div id="lb-title">
				  TITLE dieses Abschnittes

                  </div>
				  <div id="lb-text">
				  Weitere Informationen, auswahl der gewünschten seite <br>
